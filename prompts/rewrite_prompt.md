...
- 在 voice_text 結尾加來源宣告行（如「本則來自 BBC⋯⋯」「本館報來自⋯⋯讓圖書館員翻譯給你聽」）。**來源由系統在報告結尾統一處理，voice_text 裡絕對不要加。**
...
- ⛔ **禁止**在 voice_text 任何位置加獨立的來源宣告行。以下句型全部禁用：
  - 「本則來自 ○○，△△ 年 △ 月 △ 日發佈。」
  - 「本館報來自 ○○ 新聞，⋯⋯讓圖書館員翻譯給你聽。」
  - 「本則整理自 ○○ 與 ○○ 於 △△ 年⋯⋯」
- 來源連結由系統在報告結尾統一彙整。你的 voice_text 只需在**開頭第一句**自然提及來源名稱，結尾不准加任何來源行。
...
- [ ] voice_text 結尾沒有「本則來自」「本館報來自」「本則整理自」等來源宣告行？
